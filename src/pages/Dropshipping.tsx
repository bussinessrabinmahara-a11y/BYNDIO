...
const mockSuppliers = [
  { id: '1', name: 'TechSource India', category: 'Electronics', products: 1240, rating: 4.8, moq: 10, margin: '25-40%', badge: '✅ Verified' },
  { id: '2', name: 'FashionHub Delhi', category: 'Fashion', products: 3800, rating: 4.6, moq: 5, margin: '30-55%', badge: '✅ Verified' },
  { id: '3', name: 'BeautyBox Mumbai', category: 'Beauty', products: 890, rating: 4.7, moq: 20, margin: '40-60%', badge: '🔄 Pending KYC' },
  { id: '4', name: 'HomeDecor Surat', category: 'Home', products: 2100, rating: 4.5, moq: 15, margin: '20-35%', badge: '✅ Verified' },
];
...
export default function Dropshipping() {
  ...
  const handleImport = (id: string) => {
    ...
    setTimeout(() => {
      setImportingId(null);
      toastSuccess('Supplier catalog imported! Products added to your store.');
    }, 1500);
  };
