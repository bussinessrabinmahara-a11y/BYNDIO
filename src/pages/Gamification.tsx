...
const BADGES = [
  { id: 'first_order', icon: '🛍️', name: 'First Purchase', desc: 'Placed your first order', points: 50, unlocked: true },
  { id: 'reviewer', icon: '⭐', name: 'Top Reviewer', desc: 'Left 5 product reviews', points: 100, unlocked: true },
  { id: 'referrer', icon: '🤝', name: 'Super Referrer', desc: 'Referred 3 friends', points: 200, unlocked: false, progress: 1, target: 3 },
  { id: 'big_spender', icon: '💎', name: 'Big Spender', desc: 'Spent ₹10,000 on Byndio', points: 300, unlocked: false, progress: 2500, target: 10000 },
  { id: 'influencer', icon: '🌟', name: 'Micro Influencer', desc: 'Made 10 affiliate sales', points: 500, unlocked: false, progress: 3, target: 10 },
  { id: 'loyalist', icon: '🏆', name: 'Byndio Loyalist', desc: 'Member for 6 months', points: 250, unlocked: false, progress: 1, target: 6 },
  { id: 'wishlist_pro', icon: '❤️', name: 'Wishlist Pro', desc: 'Added 20 items to wishlist', points: 75, unlocked: false, progress: 5, target: 20 },
  { id: 'cart_king', icon: '🛒', name: 'Cart King', desc: 'Had 10+ items in cart', points: 50, unlocked: false, progress: 4, target: 10 },
];
...
export default function Gamification() {
  const { user, rewardPoints } = useAppStore();
